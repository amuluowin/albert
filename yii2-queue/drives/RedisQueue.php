...
class RedisQueue extends Queue implements ICoroutine
{
    ...
    {
        if (is_array($this->connector) && $this->connector) {
     ...
     * @return void
     */
    public function retry($queue, $payload, $delay, $attempts = 0)
    {
    ...
    protected function createPayload($job, $data = '', $queue = null)
    {
        ...
        return SerializeHelper::serialize($this->setMeta($payload, 'attempts', 1));
    }
    ...
    {
        $newPayload = ArrayHelper::set($payload, $key, $value);
        return $newPayload;
    }
