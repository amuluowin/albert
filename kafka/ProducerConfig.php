...
use yii\swoole\kafka\Protocol\Produce;
...
class ProducerConfig extends Config
{
    ...
    /**
     * @throws \yii\swoole\kafka\Exception\Config
     */
    ...
    public function setCompression(int $compression): void
    {
        if (! in_array($compression, self::COMPRESSION_OPTIONS, true)) {
            throw new Exception\Config('Compression must be one the \yii\swoole\kafka\Protocol\Produce::COMPRESSION_* constants');
        }
